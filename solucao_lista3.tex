...
\solucaoalt{
	...
	Como demonstrado na solução principal, a composição $(f \circ F)(u,v) = 1$. Sendo esta uma função constante, sua diferencial é nula, ou seja, $d(f \circ F) = 0$.
	...
	\end{align*}
	Assim, $F^* df = 0$.
	Concluímos que, ambos os resultados coincidem, validando a identidade.
}
%%%% QUESTÃO 11 %%%%