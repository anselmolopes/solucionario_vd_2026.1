...
\solucao{
	...
	\begin{equation*}
		\omega(X)(p) = \langle \omega_p, X_p \rangle = \left\langle \omega_i dx^i|_p, X^j \tfrac{\partial}{\partial x^j} \Big|_p \right\rangle = \omega_i(p) X^j(p) \delta^i_j = \omega_i(p) X^i(p).
	\end{equation*}
	...
	\begin{equation*}
		\omega(X_{(j)})(p) = \left\langle \omega_i dx^i|_p, \tfrac{\partial}{\partial x^j} \Big|_p \right\rangle = \omega_i(p) \delta^i_j = \omega_j(p).
	\end{equation*}
