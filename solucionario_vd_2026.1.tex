...
\begin{document}
	...
	\begin{tcolorbox}[
		...
		colback=gray!6!white, colframe=black, width=\textwidth,
		...
		\vspace{0.1cm}
		\href{https://forms.gle/UcBrKWL7YxdXCX7y9}{\textbf{\color{blue!70!black}Clique aqui para enviar suas observações via formulário}} \\
		ou, se preferir, envie para: \texttt{anselmo.ribeiro@professor.ufcg.edu.br}
	\end{tcolorbox}
	...
	\tableofcontents
	\vfill % Empurra para o fundo da página
	
	\begin{flushleft}
		\begingroup
		\renewcommand{\footnoterule}{\noindent\rule{5cm}{0.4pt}\vspace{2pt}} % Define o tamanho da linha de nota
		\footnoterule \\
		\footnotesize % Tamanho padrão de notas de rodapé
		Este solucionário é distribuído sob a \textbf{Licença CC BY-NC-SA 4.0}. \\
		Para detalhes sobre os termos, visite: \url{https://creativecommons.org/licenses/by-nc-sa/4.0/}
		\endgroup
	\end{flushleft}
	\newpage
