	...
	% --- Texto Introdutório e Resultado Extra ---
	...
	\questao{
		Seja $F : \mathbb{R}^{2n} \to \mathbb{R}^{2n}$ o campo de vetores suave definido por $F(x_1, x_2, x_3, x_4, \dots, x_{2n-1}, x_{2n}) = (x_2, -x_1, x_4, -x_3, \dots, x_{2n}, -x_{2n-1})$. Mostre que $X = F|_{\mathbb{S}^{2n-1}}$ é um campo de vetores em $\mathbb{S}^{2n-1}$ sem singularidades.
	}
